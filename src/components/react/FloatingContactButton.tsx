...
export default function FloatingContactButton() {
  ...
  return (
    <>
      {/* Bouton téléphone flottant (toujours visible sur mobile) */}
      <a
        href={getPhoneLink()}
      ...
      <style jsx>{`
        ...
        .floating-whatsapp-btn {
          ...
          font-weight: 700;
          box-shadow: 0 4px 15px rgba(164, 189, 1, 0.4);
        ...
        @keyframes pulse {
          ...
          50% {
            box-shadow: 0 4px 25px rgba(164, 189, 1, 0.7);
          }
        }
        ...
        .floating-whatsapp-btn:hover {
          transform: scale(1.1);
          box-shadow: 0 6px 20px rgba(164, 189, 1, 0.6);
          background: #8FA401;
        }

        /* Desktop : masquer le bouton téléphone (numéro dans header) */
        ...
        /* Petits écrans : texte plus court */
